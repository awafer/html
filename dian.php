...
$pass = $_POST["pass"];
$mlhy = $_POST["mlhy"];
$rename = $_POST["rename"];//安全码

$que1="select * from tbl_user where accountid='$id' and AccountPassword='$pass' and mlhy='$mlhy'";
$check = mysql_query($que1,$connect);
$total_count = mysql_affected_rows();
if($total_count==0) 
{ 
Error ("用户名或密码错误或密码保护资料填写错误！"); 
}
else
{
...
if($total_count==1)
{
$updata="update tbl_character set unkn11=Lv*4+26,Vital='0',Str='0',Tough='0',Quick='0',Magic='0' where CdKey='$id' and DataPlaceNumber='$rename'";
...
<HTML><HEAD><TITLE><?=$title?>-点数重置</TITLE>
...
</a><IMG height=45 src="image/czds.jpg" width=140 border=0><a href="skill.php"></a></p></TD>
...
<TBODY><TR><TD><IMG height=45 src="image/cz.gif" width=380 border=0></TD>
</TR><TR>
...
<form action='dian.php?act=save' method='post' name="reg" id="reg" onSubmit="return isValid()">
...
<input type="submit" name="imageField" tabIndex=6 value="提交">
</font></TD></TR><TR>
