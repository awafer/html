...
$que1="select name from tbl_character where name='$newname'";
$check1=mysql_query($que1,$connect);
...
$que1="select name from tbl_character where CdKey='$id' and DataPlaceNumber='$rename'";
...
$que1="select * from tbl_character where CdKey='$id' and DataPlaceNumber='$rename' and name='$newname'";
...
{
//写入数据库
$updata="update tbl_character set name='$newname' where CdKey='$id' and DataPlaceNumber='$rename'";
...
<HTML><HEAD><TITLE><?=$title?>-角色姓名修改</TITLE>
...
if(document.reg.newname.value.length <1 || document.reg.newname.value.length >16){
alert("温馨提示:角色姓名长度应在1-16位[限英文和数字]!!");
document.reg.newname.focus();
return false;
}
}
</script></script><META content="MSHTML 6.00.2900.2180" name=GENERATOR></HEAD>
...
<TBODY><TR><TD><p><IMG height=45 src="image/jsxg.jpg" width=140 border=0><br>      
<a href="special.php"><IMG height=45 src="image/tsxx.jpg" width=140 border=0><br>
</a><a href="dian.php"><IMG height=45 src="image/czds.jpg" width=140 border=0></a><a href="skill.php"></a></p></TD>
...
<TBODY><TR><TD><IMG height=45 src="image/rename.gif" width=380 border=0></TD></TR><TR>
...
<form action='name.php?act=save' method='post' name="reg" id="reg" onSubmit="return isValid()">
...
<TD><INPUT name=mlhy class=formborder id="mlhy" style="WIDTH: 150px; HEIGHT: 20px" tabIndex=3 onKeyDown="if(event.keyCode==13)event.keyCode=9" maxlength="16"></TD>
</TR><TR><TD align=right>人物选择</TD><TD>
<input type=radio checked value=0 name=rename>左侧<input type=radio value=1 name=rename>右侧</TD>
</TR><TR><TD align=right>新角色名称</TD>
<TD><font face="Arial, Helvetica, sans-serif">
<INPUT name=newname class=formborder id="newname" style="WIDTH: 150px; HEIGHT: 20px" tabIndex=4 maxlength="16" onKeyDown="if(event.keyCode==13)event.keyCode=9" onKeyUp="value=value.replace(/[\gmGMＧＭ]/g,'')" onbeforepaste="clipboardData.setData('text',clipboardData.getData('text').replace(/[^\d]/g,''))">
</font></TD></TR><TR><TD align=middle colSpan=2><font face="Arial, Helvetica, sans-serif">
<input type="submit" name="imageField" tabIndex=5 value="提交">
</font></TD></TR><TR>
<TD align=middle colSpan=2>*修改前请保持游戏在离线状态!</TD>
</TR></FORM></TABLE></TD></TR>
